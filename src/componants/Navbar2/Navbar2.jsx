    ...
    <nav className={style.navbar}>
      ...
      <div
        className={`${style.navlinks} ${
          isMobileMenuOpen ? style.showMenu : ""
        }`}
      >
        {/* Solution with dropdown menu*/}
        <div
          className={`${style.dropdownContainer} ${
            showSolution ? style.dropdownOpen : ""
          }`}
          ...
          >
            ...
            <IoIosArrowForward
              className={`${style.dropdownArrow} ${
                showSolution ? style.arrowRotate : ""
              }`}
            />
          </div>
        ...
        <Link
          onClick={() => {
            setActiveLink("interpetation");
            setIsMobileMenuOpen(false);
          }}
          to="/interpetation"
          className={activeLink === "interpetation" ? style.activeLink : ""}
        >
          Interpetation
        </Link>
        {/*Interpetation*/}
        ...
        <Link
          ...
          to="/platform"
          className={activeLink === "platform" ? style.activeLink : ""}
        >
          Platform
        </Link>
        ...
        <Link
          ...
          to="/ceo"
          className={activeLink === "coe" ? style.activeLink : ""}
        >
          COE
        </Link>
        ...
        <div
          className={`${style.dropdownContainer} ${
            showResources ? style.dropdownOpen : ""
          }`}
        ...
        >
          ...
          >
            <span
              className={activeLink === "resources" ? style.activeLink : ""}
            >
              Resources
            </span>
            <IoIosArrowForward
              className={`${style.dropdownArrow} ${
                showResources ? style.arrowRotate : ""
              }`}
            />
          </div>
        ...
        <Link
          ...
          to="/aboutUs"
          className={activeLink === "aboutUs" ? style.activeLink : ""}
        >
          About Us
        </Link>
      </div>
